...
int main(int argc, char* argv[]) {
  ...
  // testing.
  // Answer: Segmentation fault if the second value is set to 100 or 1000, but no errors if 
  ...
  // Answer: array acts as a pointer to other pointers
  fillArray(&value, 1);
  ...
  // C++ programming.
  // Answer: Memory leak -- memory is not released 
  free(heap_array);
